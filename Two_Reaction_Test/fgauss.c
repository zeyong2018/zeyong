...
#include "stdafx.h"
/*.BA*/
/*.KA{C 4}{Direct Methods for Solving Linear Systems}
          {Direct Methods for Solving Systems of Linear Equations}*/
/*.FE{C 4.5.1}{Gau"s Algorithm with Column Pivot Search}
...
/*.FE{C 4.5.4}
    {Gau"s Algorithm for Systems with Several Right Hand Sides}
    {Gau"s Algorithm for Systems with Several Right Hand Sides}*/
